...
(function(c) {
					...
					.each(function() {
						...
						if (h) {
							...
							i.queueData = {
								...
								uploadQueue : [],
								errorMsg : "Hàng đợi chưa có file nào:"
							};
							i.original = m;
							i.wrapper = l;
							i.button = f;
	...
	var a = {
		onDialogOpen : function() {
			var d = this.settings;
			this.queueData.errorMsg = "Hàng đợi chưa có file nào:";
			...
			if (c.inArray("onSelectError", e.overrideEvents) < 0) {
				...
				case SWFUpload.QUEUE_ERROR.QUEUE_LIMIT_EXCEEDED:
					if (e.queueSizeLimit > f) {
						this.queueData.errorMsg += "\nSố lượng file chọn vượt quá số lượng file còn lại trong hàng đợi ("
								+ f + ").";
					} else {
						this.queueData.errorMsg += "\nSố lượng file chọn vượt quá số lượng cho phép ("
								+ e.queueSizeLimit + ").";
					}
					break;
				case SWFUpload.QUEUE_ERROR.FILE_EXCEEDS_SIZE_LIMIT:
					this.queueData.errorMsg += '\nThe file "' + d.name
							+ '" Vượt quá kích cỡ file cho phép là: (' + e.fileSizeLimit
							+ ").";
					break;
				...
				case SWFUpload.QUEUE_ERROR.INVALID_FILETYPE:
					this.queueData.errorMsg += '\nFile "' + d.name
							+ '" không thuộc định dạng file cho phép ('
							+ e.fileTypeExts + ").";
					break;
				}
			}
